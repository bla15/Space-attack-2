...
public class logicaCoheteDerecho extends JLabel {
	//tamaño del cohete
	public static int tamañoX = 70;
	public static int tamañoY = 30;

	//constructor
	public logicaCoheteDerecho(){
		...
		try {
			imgagenPrimitiva =ImageIO.read(getClass().getResource("/archivos/elementosNave/coheteDerecho.png"));
		} catch (IOException e) {
