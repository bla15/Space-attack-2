...
public class logicaCoheteIzquierdo extends JLabel{
	//tamaño del cohete
	public static int tamañoX = 75;
	public static int tamañoY = 25;

	//constructor
	public logicaCoheteIzquierdo(){
		...
		try {
			imgagenPrimitiva =ImageIO.read(getClass().getResource("/archivos/elementosNave/coheteIzquierdo.png"));
		} catch (IOException e) {
